...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ember-cli/node_modules/ember-cli/lib/broccoli/ember-addon.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ember-cli/node_modules/ember-cli/lib/broccoli/ember-addon.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ember-cli/node_modules/ember-cli/lib/broccoli/</a> &#187; ember-addon.js</div>
</div>
<div class="body">
...
*/
<span class="fstat-no" title="function not covered" >function EmberAddon(defaults, options) {</span>
...
<span class="cstat-no" title="statement not covered" >    defaultsDeep(options, defaults);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  process.env.EMBER_ADDON_ENV = process.env.EMBER_ADDON_ENV || 'development';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.appConstructor(defaultsDeep(options, {</span>
    name: 'dummy',
